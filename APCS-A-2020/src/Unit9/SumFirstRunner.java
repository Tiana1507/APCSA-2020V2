...
public class SumFirstRunner
{
	public static void main( String args[] )
	{
		...
		nums9= new ArrayList<Integer>(Arrays.asList(-111,1,2,3,9,11,20,1));
		System.out.println(ListSumFirst.go(nums9));
		ArrayList<Integer> nums12;
		nums12= new ArrayList<Integer>(Arrays.asList(9,8,7,6,5,4,3,2,0,-2,6));
		...
		nums10= new ArrayList<Integer>(Arrays.asList(250,19,17,15,13,11,10,9,6,3,2,1,0));
