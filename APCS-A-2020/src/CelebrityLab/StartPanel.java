...
public class StartPanel extends JPanel {
	...
	public StartPanel(CelebrityGame controller) {
		...
		this.literatureRadio = new JRadioButton("Literature Celebrity (Literature has a VERY broad definition you know...)");
		this.movieRadio = new JRadioButton("Movie Celebrity (ik they're technically called Movie Stars but still... for the sake of this lab we call them Celebrities.");
		...
		//do kids even know who cher is? Actually Im technically a kid I shouldn't be calling everyone else kids.
		this.clueField = new JTextField("Enter celebrity clue here (10 letters minimum thx Cher)");
		//ok boomer
	...
	private void setupLayout() {
		...
		//this part sets up the movieButton
		panelLayout.putConstraint(SpringLayout.NORTH, movieRadio, 10, SpringLayout.SOUTH, literatureRadio);
		panelLayout.putConstraint(SpringLayout.WEST, movieRadio, 0, SpringLayout.WEST, literatureRadio);
